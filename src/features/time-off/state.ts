...
export const markCellInFlightAtom = atom(
  null,
  (get, set, cell: BalanceCell) => {
...
export const clearCellInFlightAtom = atom(
  null,
  (get, set, cell: BalanceCell) => {
    const next = new Set(get(inFlightCellsAtom));
...
export const markCellRefreshedAtom = atom(
  null,
  (get, set, cell: BalanceCell) => {
...
export const acknowledgeCellRefreshedAtom = atom(
  null,
  (get, set, cell: BalanceCell) => {
    const next = new Set(get(refreshedCellsAtom));
    next.delete(cellKey(cell));
